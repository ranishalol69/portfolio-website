...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToReveal = document.querySelectorAll('section, .skill-card, .project-card');
...
function typeWriter() {
    ...
    heroTitle.style.borderRightColor = 'var(--accent-color)';
...
window.addEventListener('load', () => {
    ...
    reveal(); // Check for elements to reveal
    animateSkillBars(); // Animate skill bars if visible
...
console.log('%cFeel free to explore the code!', 'font-size: 12px; color: #718096;');
